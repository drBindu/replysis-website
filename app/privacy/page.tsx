      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-3xl mx-auto space-y-12 text-gray-600 leading-relaxed">
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                { title: "Interview audio and transcripts", body: "Live audio streams from your device to our speech-to-text providers, Deepgram, with Speechmatics as a backup. Replysis does not store raw audio on its application servers. From version 1.0.20 the Windows app saves session audio only if you turn on Save session audio in Settings; it then keeps an encrypted copy on your own computer and deletes it automatically after 7 days. Version 1.0.19 and earlier saved that copy for every session. Session audio is never uploaded. Transcripts are processed to generate output and may be stored when you use saved session history." },
          ...
          <div>
            ...
            <p className="text-sm">Account, subscription, credit, and saved-session data is retained while your account is active or as needed for legal, fraud-prevention, and billing obligations. Saved session history remains until it is deleted. Screen captures are deleted from Replysis servers within 90 seconds. Session audio saved by the Windows app (always in 1.0.19 and earlier, only when turned on from 1.0.20) stays on your computer, encrypted, and is deleted automatically after 7 days. We aim to complete verified account-deletion requests within 30 days unless retention is legally required.</p>
          </div>

...
export const TESTIMONIALS = [
  { name: "Aarav Mehta",  role: "SDE-2 @ Google",         initials: "AM", grad: "from-zinc-800 to-zinc-900", stars: 5, text: "Landed my Google offer after 3 weeks of practice with Verchor. Every answer used my actual resume. No generic filler. Got the offer and a 34% salary bump." },
  ...
  { name: "Sneha Iyer",   role: "Data Scientist @ Amazon", initials: "SI", grad: "from-zinc-800 to-zinc-900",  stars: 5, text: "Every answer references my real projects. Interviewers kept saying great specific example. That was Verchor. Resume-grounded answers are the standout feature." },
  { name: "Arjun Nair",   role: "ML Engineer @ Meta",      initials: "AN", grad: "from-zinc-800 to-red-500",    stars: 5, text: "Built my resume with Verchor then used mock interviews to prep. Went from 0 callbacks to 4 interviews in one week. This product is absurdly good." },
];

...
const STRENGTHS = [
  ...
  },
  {
    ...
    body: "One missed word can produce a completely wrong answer. We run Speechmatics streaming recognition so your words are transcribed as you speak them, not after you finish. What you say is what we hear.",
  ...
  },
  {
    ...
    title: "Built to stay off the shared screen",
    body: "Our overlay is marked at the operating system level to be excluded from screen capture, so it stays out of screen shares and recordings that use the standard Windows capture path. Coverage depends on the tools in use, so check the rules of any interview you are taking.",
